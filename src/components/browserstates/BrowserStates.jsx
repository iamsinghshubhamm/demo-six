    ...
    <tbody className="bg-white dark:bg-box-dark">
      {data.map((product, index) => (
        <tr key={index} className="group">
          ...
          <td className="px-4 py-2.5 font-normal capitalize text-end text-[14px] text-dark dark:text-title-dark border-none group-hover:bg-transparent">
            {product.cte}
          </td>
